...
#define V_TYPEDEF(XX, TypeName)                                                               \
    ...
    {                                                                                         \
        ...
        u8 (*append)(struct __##TypeName##_t * v, XX d);                                      \
        ...
        void (*insert)(struct __##TypeName##_t * v, u32 index, XX value);                     \
        ...
        u8 (*compare)(XX * v1, XX *v2);                                                       \
        void (*toString)(XX * value);                                                         \
        void (*deleteSub)(XX value);                                                          \
    } VCT_##TypeName;
...
#define V_APPEND(XX, TypeName)                                    \
    inline u8 __VCT_appendVCT_##TypeName(VCT_##TypeName *v, XX d) \
    {                                                             \
        if (v != NULL)                                            \
        {                                                         \
...
#define V_INSERT(T, TypeName)                                                     \
    inline void __VCT_insertVCT_##TypeName(VCT_##TypeName *v, u32 index, T value) \
    {                                                                             \
        if (v != NULL)                                                            \
        {                                                                         \
            if (index > v->size)                                                  \
...
#define V_SORT(T, TypeName)                                        \
    ...
    {                                                              \
        ...
        while (i < j)                                              \
        {                                                          \
            while (i < j && v->compare((T *)&pivot, (T *)(a + j))) \
            {                                                      \
                j--;                                               \
            }                                                      \
            if (i < j)                                             \
            ...
            while (i < j && v->compare((T *)a + i, (T *)&pivot))   \
            {                                                      \
                i++;                                               \
            }                                                      \
            if (i < j)                                             \
...
#define V_Declare_Vector(T, TypeName)                                         \
    ...
    u8 __VCT_appendVCT_##TypeName(VCT_##TypeName *v, T d);                    \
    ...
    void __VCT_insertVCT_##TypeName(VCT_##TypeName *v, u32 index, T value);   \
    void __VCT_sortVCT_##TypeName(VCT_##TypeName *v);                         \
